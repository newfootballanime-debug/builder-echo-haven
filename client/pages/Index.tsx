...
export default function Index() {
  ...
  const text = {
    en: {
      ...
      description: 'Create your footballer and live a complete career with spectacular Champions League style draws!',
      features: {
        draws: 'Lottery Draws',
        drawsDesc: 'Spectacular visual extractions for every important decision',
        career: 'Complete Career',
        careerDesc: 'From debut to retirement, with realistic trophies and transfers',
      ...
      footer: 'Inspired by classic football simulation mechanics with a modern interface'
    },
    ro: {
      title: 'FOTBAL',
      subtitle: 'SIMULATOR DE CARIERĂ',
      description: 'Creează-ți fotbalistul și trăiește o carieră completă cu trageri la sorți spectaculoase în stil Champions League!',
      features: {
        draws: 'Trageri la Sorți',
        drawsDesc: 'Extrageri vizuale spectaculoase pentru fiecare decizie importantă',
        career: 'Carieră Completă',
        careerDesc: 'De la debut până la retragere, cu trofee și transferuri realiste',
        leagues: 'Ligi Reale',
        leaguesDesc: 'Joacă în Premier League, La Liga, Serie A și multe altele'
      },
      ...
      footer: 'Inspirat de mecanismele clasice de simulare fotbal cu o interfață modernă'
    }
  };
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              <details className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 md:open">
                <summary className="p-4 md:p-8 cursor-pointer md:cursor-default">
                  <h3 className="text-lg md:text-2xl font-bold text-white inline">{currentText.whatCanYouDo}</h3>
                ...
                <div className="px-4 pb-4 md:p-8 md:pt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 text-left">
                    <div className="space-y-2 md:space-y-3">
                      {currentText.gameFeatures.slice(0, 4).map((feature, index) => (
                        <div key={index} className="flex items-start gap-3 text-blue-100 text-sm md:text-base">
                    ...
                    <div className="space-y-2 md:space-y-3">
                      {currentText.gameFeatures.slice(4).map((feature, index) => (
                        <div key={index} className="flex items-start gap-3 text-blue-100 text-sm md:text-base">
                          <span className="text-yellow-400 mt-1">⚽</span>
                          <span>{feature}</span>
                        </div>
              ...
              <details className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 md:open">
                <summary className="p-4 md:p-8 cursor-pointer md:cursor-default">
                  <h3 className="text-lg md:text-2xl font-bold text-white inline">{currentText.availableLeagues}</h3>
                  <span className="float-right md:hidden">▼</span>
                </summary>
                <div className="px-4 pb-4 md:p-8 md:pt-0">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 text-center">
                    <div className="text-blue-100">
                      ...
                      <div className="font-semibold text-sm md:text-base">Premier League</div>
                      <div className="text-xs md:text-sm">Man City, Liverpool, Arsenal...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇪🇸</div>
                      <div className="font-semibold text-sm md:text-base">La Liga</div>
                      <div className="text-xs md:text-sm">Real Madrid, Barcelona...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇮🇹</div>
                      <div className="font-semibold text-sm md:text-base">Serie A</div>
                      <div className="text-xs md:text-sm">Juventus, Inter, Milan...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇩🇪</div>
                      <div className="font-semibold text-sm md:text-base">Bundesliga</div>
                      <div className="text-xs md:text-sm">Bayern, Dortmund...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇫🇷</div>
                      <div className="font-semibold text-sm md:text-base">Ligue 1</div>
                      <div className="text-xs md:text-sm">PSG, Marseille...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇵🇹</div>
                      <div className="font-semibold text-sm md:text-base">Primeira Liga</div>
                      <div className="text-xs md:text-sm">Porto, Benfica...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇳🇱</div>
                      <div className="font-semibold text-sm md:text-base">Eredivisie</div>
                      <div className="text-xs md:text-sm">Ajax, PSV...</div>
                    </div>
                    <div className="text-blue-100">
                      <div className="text-xl md:text-2xl mb-1 md:mb-2">🇷🇴</div>
                      <div className="font-semibold text-sm md:text-base">Liga 1</div>
                      <div className="text-xs md:text-sm">FCSB, CFR Cluj...</div>
                    </div>
                  </div>
                </div>
              </details>
