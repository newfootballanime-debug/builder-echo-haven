...
const TEAM_LISTS_2025_26: Record<string, Record<string, string>> = {
  ...
  Portugal: {
    "Primeira Liga":
      "Benfica, Porto, Sporting CP, Braga, Vitória Guimarães, Boavista, Gil Vicente, Famalicão, Santa Clara, Estoril, Marítimo, Paços de Ferreira, Portimonense, Vizela, Chaves, Arouca, Rio Ave, Casa Pia",
    "Liga Portugal 2":
